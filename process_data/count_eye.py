...
data_folders = '/mnt/hgfs/work/eye_data/source_eye_data/data_1109/'
...
if __name__ == '__main__':
    ...
    for r in sub_dir_types_num:
        ...
        if 'a_close' not in sub_dir_types_num[r]:
            ...
            print sub_dir_types_num[r]['a_close']
        ...
        key = path_list[-4] + path_list[-3] +os.sep + path_list(os.sep)[-2] +os.sep +path_list[-1]
        print ("|  %-4d  | %-60s | %-10d | %-10d | %-10d | %-11d |    " % (
            count, str(key), a_open, a_close, glass_open, glass_close))

    print ("|  %-4s  | %-60s | %-10d | %-10d | %-10d | %-11d |    " % (
